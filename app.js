...
vk.setOptions({ token: '44c1a45e12f3c825022e279cde843b6b53732f9e22bc22f61df3f4c4b66ff8a5097ee0de40bd5f62a9ff9', pollingGroupId: 188810406 });
const { updates, snippets } = vk;

updates.startPolling();
updates.on('message', async (message) => {
	if(Number(message.senderId) <= 0) return;
	if(/\[club185850187\|(.*)\]/i.test(message.text)) message.text = message.text.replace(/\[club185850187\|(.*)\]/ig, '').trim();
